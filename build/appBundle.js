 ...
 * CLI version: 2.7.2
 * 
 * Generated: Tue, 22 Mar 2022 12:10:55 GMT
 */

var APP_com_mca_project1 = (function () {
  'use strict';
  ...
  var _where = "C:\\work\\OneDrive - Naspers\\ArchForum\\Projects\\HTML5-UI\\Credesi-LightningTraining\\lightning-assignment\\project1";
  var bugs = {
      ...
      return {
        ...
        Label: {
          ...
          text: {
            ...
            fontSize: 48,
            textAlign: 'center',
            text: 'TMDB - Coming Soon Movies Menu\nPress OK to Enter the Menu'
          }
        }
      };
    }
  ...
  class MovieDetails extends Lightning.Component {
    static _template() {
      return {
        Background: {
          w: 1920,
        ...
        Label: {
          ...
          y: 980,
          text: {
            text: "Press Back to go to Movies",
            fontSize: 48,
    ...
    async populateMovieDetails(movieId) {
      ...
      this.tag("Poster").patch({
        src: getImageURL(this.details.poster_path, 300)
      });
      this.tag("Background").patch({
        src: getImageURL(this.details.backdrop_path, 1280)
      });
      this.tag("MovieDetails").patch({
        Title: {
          text: {
            text: this.details.original_title
          }
        }
      });
      this.tag("MovieDetails").patch({
        ReleaseDate: {
          text: {
            text: this.details.release_date
          }
        }
      });
      this.tag("MovieDetails").patch({
  ...
  class MovieItem extends Lightning.Component {
    static _template() {
      return {
        flexItem: false,
        Image: {
  ...
  class Movies extends Lightning.Component {
    static _template() {
      return {
        ...
        Label: {
          ...
          y: 100,
          text: {
            text: "Press Right to check new upcoming movie"
          }
        },
        ImageContainer: {
          x: 1921,
        ...
        Action: {
          ...
          y: 950,
          text: {
            text: "Press OK to see more details"
          }
        }
      };
    }
    ...
    async _init() {
      ...
      this.tag("Title").patch({
        text: {
          text: this.mList.results[this.index].original_title
        }
      });
    }
    ...
    _focus() {
      ...
      if (this.index > 0) this.items[this.index].zoomOut.start();
      this.index = 0;
    ...
    _handleRight() {
      ...
      setTimeout(() => {
        for (let [index, item] of this.items.entries()) {
          if (item.zIndex == this.items.length) item.patch({
            zIndex: 1
          });else item.patch({
